...
[**FORELDR**](https://foreldr.com) — веб-приложение (PWA) с AI-персонажами, разработано с нуля: 12-стадийный пайплайн обработки сообщений, долговременная память на pgvector, multi-provider LLM-роутинг с prompt caching, генерация фото/видео и WebSocket-чат в реальном времени.
